...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Todo web application."
  #
  #
  ...
  #
  # settings.secret_key_base= LrQarQJoFQ9ogYrjXRfh3A1PVX5Dly6i2EEzPdp3CAQ
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("todo.log", "w"))
  #
  #
end
